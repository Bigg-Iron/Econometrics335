...
packages <- c("tidyverse", "dplyr", "moments", "lmtest", "sandwich", "stringr", "readr", "here", "ggplot2", "modelr")
...
summary.lm(modelA <- lm(formula = rural_atlas_merged$PerCapitaInc ~ rural_atlas_merged$UnempRate2013))

# Intercept = 34507.06
# Slope = -1152.81
# The slope of -1152.81 means that when the unemployment rate differs by 1%, on average the per capita income is lower by $1,152.81
