...
coeftest(metro_model, vcov = vcovHC(metro_model, type = "HC0"))
...
coeftest(non_metro_model, vcov = vcovHC(non_metro_model, type = "HC0"))

confint(non_metro_model, level = 0.99)
# 1% level: Not statistically significant

confint(non_metro_model, level = 0.95) 
# 5% level: Not statistically significant

confint(non_metro_model, level = 0.90) 
# 10% level: Not statistically significant
...
coeftest(model_i, vcov = vcovHC(model_i, type = "HC0"))
