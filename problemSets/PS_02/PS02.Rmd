...
lower <- lm_summ$coefficients[2,1] - qt(0.975, df = lm_summ$df[2]) * lm_summ$coefficients[2, 2]

# Upper -1152.81 + 1.96 * 31.33 = -1091.387
upper <- lm_summ$coefficients[2, 1] + qt(0.975, df = lm_summ$df[2]) * lm_summ$coefficients[2, 2]
