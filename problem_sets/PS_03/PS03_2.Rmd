...
TODO: Now, what is the estimated effect of UnempRate2013 in words? Also indicate if the relationship is statistically significant at the 10%, 5%, and 1% levels? Make sure that you are using heteroskedastic standard errors.
...
```{r}
# An increase in the R2 or R2 does not necessarily mean that an added variable is statistically significant 
