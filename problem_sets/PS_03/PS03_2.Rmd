...
- The $R^2$ and the $\bar{R}^2$ are similar because...
...
# The F-statistic is: 1618 on 5 and 3213 DF
# The value of the F-statistic computed from the data, 1618, exceeds 3.02, so the null hypothesis is rejected at the 1% level 

# as summarized in this F-statistic, we can reject the null hypothesis that the UnempRate2013 and Ed5CollegePlusPct have no effect on PerCapitaInc (holding constant: BlackNonHispanicPct2010, HispanicPct2010, and Metro2013).
