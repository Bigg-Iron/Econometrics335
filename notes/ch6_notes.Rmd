...
packages <- c("tidyverse", "dplyr", "moments", "lmtest", "sandwich", "stringr", "readr", "here", "ggplot2", "modelr", "MASS", "knitr", "formatR", "tinytex", "AER", "MASS", "mvtnorm", "plotly")
...
# Ch. 6: Regression Models with Multiple Regressors {#rmwmr}
...
$$ \widehat{TestScore} = 686.03 - 1.10 \times STR - 0.65 \times PctEL \tag{Holding PctEL constant} $$
