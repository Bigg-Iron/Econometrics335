...
$$ \widehat{MortalityRate_{it}} =   \underset{(0.03481)}{54.966} - \underset{(2.43e-07)}{[8.3513e-07} \times indv\_pctile_{it}] + u_{it} $$
```{r}
...
## Individual Income Percentile and Life Expectancy
